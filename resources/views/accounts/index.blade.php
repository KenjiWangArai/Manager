							...
							<div class="row" style="display: flex; align-items: center;">
								...
								<div class="col-md-10 col-sm-12">
									<div class="form-group">
										...
										{{ Form::text('name', $user->name ,array('id'=>'name','class'=>'form-control', 'disabled' => 'disabled')) }}
									</div> 
									<div class="form-group">
										{{ Form::label('Email','Steam Name',array('id'=>'','class'=>'')) }}
										{{ Form::text('steamname', $user->email ,array('id'=>'steamname','class'=>'form-control', 'disabled'=>'true')) }}
									</div>
								</div>
							</div>
						{{ Form::close() }}
